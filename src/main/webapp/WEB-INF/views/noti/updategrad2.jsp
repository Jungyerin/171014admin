		...
		<div class="w3-col m10 l10">
			<div class="w3-row">
				<div class="w3-large w3-card-2 w3-white">
					<h5 class="w3-padding-16">
						<a href="" class="w3-margin-left w3-margin-right"
							...
							class="w3-margin-left w3-text-red" style="letter-spacing: 0.1em;">대학원
							모집공고</a>
					</h5>
				</div>
				...
				<div
					...
					<div class="container">
						<div class="w3-row">
							<h4 class="w3-margin-left" style="letter-spacing: 0.3em;">대학원
								모집공고 수정</h4>
						</div>
						...
						<div id="notigrad" class="w3-row">
							<form class="login-form" id="login-form" name="loginform"
								...
								<input type="hidden" name="type" id="type" value="${vo.slctnNotiDstnct}"> <input
								...
								<div
									...
									<div class="w3-row">
										<div class="w3-col" style="width: 150px">
											<label>기관번호:</label> <input class="w3-input" id="orgnzNo1"
												name="orgnzNo" type="text" value="${vo.orgnzNo }" readonly>
										</div>
										<div class="w3-rest">
											<label>기관명:</label> <input class="w3-input" id="organzinput"
												type="text" value="${vo.orgnzFullNm }" readonly>
										</div>
										<br>
										<button type="button"
											class="w3-button w3-blue w3-block w3-round" type='button'
									...
									<div class="w3-half w3-margin-bottom">
										<label>모집년도:</label> <input class="w3-input" type="text"
											name="slctnYycl" value="${vo.slctnYycl }">
									</div>
									...
									<Br> <label>대학원 모집 url:</label> <input class="w3-input"
										id="slctnNotiUrl" name="slctnNotiUrl" type="text"
										value="${vo.slctnNotiUrl }"> <br> <label>모집내용:
									</label>
									...
									<div class="ui-widget">
										<label for="tags">학문코드</label> <br> <input
											class="w3-input" id="tags">
										<div id="duplicateMsg" style="display: none">중복입니다 !!</div>
										<div id="cdNmList"></div>
									</div>
									<br> <label>전형방법:</label>
									<textarea class="w3-input" rows="3" id="slsnMth" name="slsnMth">${vo.slsnMth }</textarea>
								...
								<div
									...
									<div class="w3-row w3-row-padding w3-margin-bottom">
										<div class="w3-half">
											<label>접수기간(시작): </label> <input class="w3-input"
												id="slctnBeginDt" name="slctnBeginDt" type="text"
												value="${vo.slctnBeginDt }">
										</div>
										<div class="w3-half">
											<label>접수기간(종료): </label> <input class="w3-input"
									...
									<Br> <label> 접수 장소 : </label>
									<textarea class="w3-input" rows="2" id="slsnPlac"
										name="slsnPlac">${vo.slsnPlac }</textarea>

									<Br> <label>합격자 발표 </label> <label>발표일:</label> <input
										class="w3-input" id="sccnAncmDd" name="sccnAncmDd" type="text"
										value="${vo.sccnAncmDd }"> <br> <label>장소:</label>
									<textarea class="w3-input" rows="2" id="sccnAncmMth"
										name="sccnAncmMth">${vo.sccnAncmMth }</textarea>
									<Br> <label> 등록기간: </label>
									<div class="w3-row w3-row-padding w3-margin-bottom">
										<div class="w3-half">
											<label>시작일:</label> <input class="w3-input" id="regstBeginDd"
												name="regstBeginDd" type="text" value="${vo.regstBeginDd }">
										</div>
										<div class="w3-half">
											<label>종료일:</label> <input class="w3-input" id="regstEndDd"
												name="regstEndDd" type="text" value="${vo.regstEndDd }">
										</div>
									</div>
								...
								<div class="w3-row">
									...
									<div
										...
										<label>모집인원: </label> <input class="w3-input" id="slctnNops"
											name="slctnNops" type="text" value="${vo.slctnNops }">
										<br> <label>담당자: </label> <input class="w3-input"
											id="chrgrNm" name="chrgrNm" type="text"
											value="${vo.chrgrNm }"> <br> <label>전화번호:
										</label> <input class="w3-input" id="chrgrTelNo" name="chrgrTelNo"
											type="text" value="${vo.chrgrTelNo }"> <br> <label>email:
										</label> <input class="w3-input" id="chrgrEmail" name="chrgrEmail"
											type="text" value="${vo.chrgrEmail }"> <br> <label>로고등록:
										</label>
										...
										<button type="submit"
											class="w3-button w3-block w3-border w3-round-large w3-margin-bottom w3-large">모집공고
											수정</button>
									</div>
								</div>
							</form>
