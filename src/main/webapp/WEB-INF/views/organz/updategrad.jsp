						...
						<div class="w3-row">
							...
							<form class="updateform" id="updateform" name="updateform"
								...
								<div
									...
									<input type="hidden" id="type" name="type"
										value="${param.type }"> <input type="hidden"
										class="w3-input" id="orgnzDstnct" name="orgnzDstnct"
										value="${vo.orgnzDstnct }" readonly> <label>기관명:</label>
									<input type="text" class="w3-input" id="orgnzNm" name="orgnzNm"
										value="${vo.orgnzNm }"> <br> <label>기관영문명:</label>
									<input type="text" class="w3-input" id="engOrgnzNm"
										name="engOrgnzNm" value="${vo.engOrgnzNm }"> <br>
									<label>상징색상명:</label> <input type="text" class="w3-input"
										id="symbolColorNm" name="symbolColorNm"
										value="${vo.engOrgnzNm }"> <br> <label>홈페이지주소:</label>
									<input type="text" class="w3-input" id="hmpageUrl"
										name="hmpageUrl" value="${vo.hmpageUrl }"> <br> <label>전화번호:</label>
									<input type="text" class="w3-input" id="telNo" name="telNo"
										value="${vo.telNo }"> <br> <label>팩스번호:</label> <input
										type="text" class="w3-input" id="faxNo" name="faxNo"
										value="${vo.faxNo }"> <br> <label>주소:</label> <input
										type="text" class="w3-input" id="addr" name="addr"
										value="${vo.addr }"> <br> <label>상세주소:</label> <input
										type="text" class="w3-input" id="detailAddr" name="detailAddr"
										value="${vo.detailAddr }"> <br>

								</div>
								<div
									class="w3-col s12 m5 l5 w3-row w3-padding-16 w3-row-padding w3-medium">
									<label>국내외 구분:</label> <select
										class="w3-input w3-select w3-white" id="hmnbrdDstnct"
										name="hmnbrdDstnct" style="height: 2.7em;">
									...
									<c:if test="${param.type == '대학원' }">
										...
										<select class="w3-input w3-select w3-white" id="grschDstnct"
											name="grschDstnct" style="height: 2.7em;">
									...
									<c:if test="${param.type == '대학원' }">
										<div class="w3-row-padding">
											<label> 지역 : </label> <br>
											<div class="w3-third">
												<input class="w3-radio" type="radio" name="cdlist"
													id="seoul" value="AR00001"><label for="seoul">서울</label>
												<input class="w3-radio" type="radio" name="cdlist"
													id="sejong" value="AR00002"><label for="sejong">세종</label><br>
												<input class="w3-radio" type="radio" name="cdlist"
													id="inchon" value="AR00003"><label for="inchon">인천</label>
												<input class="w3-radio" type="radio" name="cdlist" id="dj"
													value="AR00004"><label for="dj">대전</label><br>
												<input class="w3-radio" type="radio" name="cdlist" id="dg"
													value="AR00005"><label for="dg">대구</label> <input
													class="w3-radio" type="radio" name="cdlist" id="ps"
													value="AR00006"><label for="ps">부산</label><br>
											</div>
											<div class="w3-third">
												<input class="w3-radio" type="radio" name="cdlist" id="ul"
													value="AR00007"><label for="ul">울산</label> <input
													class="w3-radio" type="radio" name="cdlist" id="gw"
													value="AR00008"><label for="gw">광주</label><br>
												<input class="w3-radio" type="radio" name="cdlist" id="kk"
													value="AR00009"><label for="kk">경기</label> <input
													class="w3-radio" type="radio" name="cdlist" id="cb"
													value="AR00010"><label for="cb">충북</label><br>
												<input class="w3-radio" type="radio" name="cdlist" id="cn"
													value="AR00011"><label for="cn">충남</label> <input
													class="w3-radio" type="radio" name="cdlist" id="kw"
													value="AR00012"><label for="kw">강원</label><br>
											</div>
											<div class="w3-third">
												<input class="w3-radio" type="radio" name="cdlist" id="kb"
													value="AR00013"><label for="kb">경북</label> <input
													class="w3-radio" type="radio" name="cdlist" id="kn"
													value="AR00014"><label for="kn">경남</label><br>
												<input class="w3-radio" type="radio" name="cdlist" id="jb"
													value="AR00015"><label for="jb">전북</label> <input
													class="w3-radio" type="radio" name="cdlist" id="jn"
													value="AR00016"><label for="jn">전남</label><br>
												<input class="w3-radio" type="radio" name="cdlist" id="jj"
													value="AR00017"><label for="jj">제주</label> <input
													class="w3-radio" type="radio" name="cdlist" id="br"
													value="AR00018"><label for="br">국외</label><br>
											</div>
										</div>
										...
										<div class="form-group">
											<label> 학위 :</label> <br> <input class="w3-check"
												type="checkbox" name="cdlist" value="DE00001">석사&nbsp;
											<input class="w3-check" type="checkbox" name="cdlist"
												value="DE00002">박사&nbsp; <input class="w3-check"
									...
									<c:if test="${param.type == '학과' || param.type == '대학원'}">
										...
										<div class="form-group">
											<label>부모 기관번호:</label> <input class="w3-input" id="orgnzNo1"
												name="prntsOrgnzStr" type="text" value="${vo.prntsOrgnzNo }"
												readonly>
										</div>
										<br>
										<div class="form-group">
											<label>부모 기관명:</label> <input class="w3-input"
												id="organzinput" name="orgnzFullNm" type="text"
												value="${vo.orgnzFullNm }" readonly>

											<c:choose>
												<c:when test="${param.type=='대학원' }">
													<button class="w3-button w3-blue" type='button'
														onclick="openOrganzSearch('대학교');">기관검색하기</button>
												</c:when>
												<c:when test="${param.type=='학과' }">
													<button class="w3-button w3-blue" type='button'
														onclick="openOrganzSearch('대학원');">기관검색하기</button>
												</c:when>
											</c:choose>
									...
									<c:choose>
										<c:when test="${param.type == '학과' }">
											<br>
											<div class="ui-widget">
												<label for="tags">학과/학부코드 : </label> <input class="w3-input"
													id="tags">
											...
											<br>
											<div class="ui-widget">
												<label for="tags2">세부전공코드 : </label> <input class="w3-input"
													id="tags2">
											...
											<br>
											<label><input class="w3-check" name="aboltYn"
												type="checkbox" value="Y"> 폐지여부</label>
											<br>
											<br>
										</c:when>
										<c:otherwise>
									...
									<div id="filetable" cellpadding="5" cellspacing="0">
										<label name="tr_attach_file"><i
											class="far fa-file-image fa-2x"></i> </label> <Br> <input
											id="file" type="file" name="attachFile" multiple />
									...
									<button type="submit"
										...
										style="letter-spacing: 2px;">입력</button>
								</div>
